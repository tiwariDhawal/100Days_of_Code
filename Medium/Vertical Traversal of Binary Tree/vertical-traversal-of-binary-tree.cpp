...
class Solution
{
    ...
    {
        //Your code here
        //Step1: To make the map which contains the hd level and the list of nodes
        //Step2: Making a queue for traversing the binary tree level wise for hd and level 
        map<int,map<int,vector<int>>>nodes;
        queue<pair<Node*,pair<int,int>>>q;
        //Here the first zero is for the hd and second for the level 
        q.push({root,{0,0}});
        vector<int>ans;
        while(!q.empty()){
