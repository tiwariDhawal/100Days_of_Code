<h2><a href="https://practice.geeksforgeeks.org/problems/check-if-subtree/1?page=1&difficulty[]=0&difficulty[]=1&status[]=unsolved&category[]=Tree&sortBy=submissions">Check if subtree</a></h2><h3>Difficulty Level : Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given two binary trees with head reference as <strong>T</strong><strong> </strong>and <strong>S</strong> having at most <strong>N</strong> nodes. The&nbsp;task is to check if S is present as subtree in T.<br>
